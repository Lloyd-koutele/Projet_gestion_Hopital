...
public class ChercheurEntite extends User
{
    @Size(min = 2, max = 100, message = "La spécialité doit contenir entre 2 et 100 caractères")
    @Column(nullable = true, length = 100)
    private String specialiteRecherche;

    public ChercheurEntite () {
        super();
    }

    public ChercheurEntite(String nom, String prenom, String email, String password, String telephone, String specialiteRecherche) {
        super();
        this.setNom(nom);
