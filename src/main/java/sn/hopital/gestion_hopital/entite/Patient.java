...
public class Patient
{
    ...
    private MedecinEntite medecinReferent;
    ...
    public Patient(String nom, String prenom, String email, DossierMedical dossierMedical, Date dateNaissance, String telephone, MedecinEntite medecinReferent)
    {
    ...
    /**
     * Ajoute une autorisation d'accès à ce patient
     */
    ...
    /**
     * Supprime une autorisation d'accès à ce patient
     */
