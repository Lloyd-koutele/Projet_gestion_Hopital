...
public class AutorisationAccesPatient {
    ...
    private MedecinEntite medecinAutorise;
    ...
    private MedecinEntite medecinAccordeur;
    ...
    public AutorisationAccesPatient(Patient patient, MedecinEntite medecinAccordeur,
                                     MedecinEntite medecinAutorise, NiveauAcces niveauAcces) {
    ...
    public AutorisationAccesPatient(Patient patient, MedecinEntite medecinAutorise,
